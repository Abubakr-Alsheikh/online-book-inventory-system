<%@ Page Title="Edit Book" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditBook.aspx.cs" Inherits="Online_Book_Inventory_System.EditBook" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="mt-5">Edit Book</h2>
    <asp:Label ID="IdLabel" runat="server" Text="ID" Visible="false" />
    <div class="row min-vh-100 mt-5 align-items-start">
        <div class="h-100 d-flex position-relative w-100 flex-lg-row flex-column">
            ...
            <div class="col-lg-6 d-flex flex-fill justify-content-between flex-column ps-3 text-secondary ">
                ...
                <div class="form-group">
                    <asp:Button ID="AddButton" runat="server" CssClass="btn btn-primary rounded-pill px-4 w-25 mb-5" Text="Edit" OnClick="UpdateButton_Click" />
                </div>
